...
namespace Aacademy.Models
{
	internal class Human
	{
		...
		public byte[] SerializePhoto()      //Перевод фото в последовательноть байт - Сериализация.
		{
		...
		{
			return $"N'{last_name}',N'{first_name}',N'{middle_name}',N'{birth_date}',N'{email}',N'{phone}'"; //Возвращает значение каждой переменной.
		}
